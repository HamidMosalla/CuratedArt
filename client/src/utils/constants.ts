// APP TEXT
export const APP_TITLE = 'Curated Art App';
export const APP_DESCRIPTION = 'Asp.Net Core, React, TypeScript, Material-UI boilerplate by Hamid Mosalla, Developer.';
export const FOOTER_TEXT = `${new Date().getFullYear()} Proudly made by Hamid Mosalla`;
// PAGES TITLE
